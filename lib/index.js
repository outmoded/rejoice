...
internals.jsParser = function (manifestPath, args) {
...
internals.jsonParser = function (manifestPath, args) {
...
internals.getManifest = function (args) {
    ...
    var path = Hoek.isAbsolutePath(args.c) ? args.c : Path.join(process.cwd(), args.c);
    var ext = Path.extname(path);
    var manifest = (ext === '.js') ? internals.jsParser(path, args) : internals.jsonParser(path, args);
